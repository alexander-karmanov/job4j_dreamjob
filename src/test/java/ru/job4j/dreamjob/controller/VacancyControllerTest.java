...
public class VacancyControllerTest {
    ...
    public void whenRequestVacancyListPageThenGetPageWithVacancies() {
        var vacancy1 = new Vacancy(1, "title1", "desc1", now(), true, 1, 2);
        var vacancy2 = new Vacancy(2, "title2", "desc2", now(), false, 3, 4);
    ...
    public void whenPostVacancyWithFileThenSameDataAndRedirectToVacanciesPage() throws Exception {
        var vacancy = new Vacancy(1, "title1", "desc1", now(), true, 1, 2);
    ...
    @Test
    public void whenUpdateVacancyThenUpdateDataAndRedirectToVacanciesPage() throws Exception {
        var vacancy = new Vacancy(1, "title1", "desc1", now(), false, 1, 2);
        var fileDto = new FileDto(testFile.getOriginalFilename(), testFile.getBytes());
        var vacancyArgumentCaptor = ArgumentCaptor.forClass(Vacancy.class);
        var fileDtoArgumentCaptor = ArgumentCaptor.forClass(FileDto.class);
    ...
    @Test
    public void whenUpdateNonExistingVacancyThenGetErrorPage() throws Exception {
        var vacancy = new Vacancy(1, "title1", "desc1", now(), false, 1, 2);
    ...
    @Test
    public void whenDeleteNonExistingVacancyThenGetErrorPage() {
        var vacancyId = 1;
